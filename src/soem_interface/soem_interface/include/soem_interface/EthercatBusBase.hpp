...
#include <soem_interface/common/soem_export.h>
#include <soem_interface/common/EthercatTypes.hpp>
#include <soem_interface/common/ExtendedRegisters.hpp>
#include <soem_interface/common/Macros.hpp>
#include <soem_interface/common/ObjectDictionaryUtilities.hpp>
...
namespace soem_interface
{
  ...
  class SOEM_EXPORT EthercatBusBaseTemplateAdapter
  {
  private:
   ...
   *             slaves
   */
  class SOEM_EXPORT EthercatBusBase : private EthercatBusBaseTemplateAdapter
  {
  public:
    ...
    soem_interface::ETHERCAT_SM_STATE getEthercatState(const uint16_t slave = 0);
