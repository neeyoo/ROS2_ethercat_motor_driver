...
namespace soem_interface
{
  ...
  enum class SOEM_EXPORT ETHERCAT_SM_STATE : uint16_t
  {
    /** No valid state. */
    NONE = 0x00,
    /** Init state*/
  ...
  enum class SOEM_EXPORT ETHERCAT_TYPE : uint16_t
  {
    ECT_BOOLEAN = 0x0001,
    ECT_INTEGER8 = 0x0002,
  ...
  namespace EcAccess
  { // make sure that no name conflicts, but allowing implicit conversion.
